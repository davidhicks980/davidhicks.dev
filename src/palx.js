...
var desat = function (n) {
  return function (hex) {
    var _a = chroma(hex).hsl(),
      h = _a[0],
      s = _a[1],
      l = _a[2];
...
var palette = palx('#5831f4');
var sasspalette = Object.entries(palette)
  .filter(function (_a) {
    var key = _a[0],
      value = _a[1];
  ...
  .flat()
  .join('  ');
fs.writeFileSync('./util/_variables.scss', ':root{' + sasspalette + '}');
