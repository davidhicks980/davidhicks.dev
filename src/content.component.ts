    ...
    subcontent: [
      {
          ...
          <main class="layout__list">
            ...
            <hicks-card-container>
              ${[
                ...
                { title: 'Section Speed', body: 'Who has time?' },
                {
                  title: 'Section Simplicity',
        ...
        subcontent: [
          ...
          },
          {
            ...
            subcontent: [
              {
                title: 'Section 2.1.5.1',
                content: html` test2 `,
              },
              {
                title: 'Section 2.1.5.2',
                content: html` test2 `,
              },
              {
                title: 'Section 2.1.5.3',
                content: html` test2 `,
              },
            ],
          },
      ...
      },
      {
        ...
        subcontent: [
          {
            title: 'Section 2.2.1',
            content: html`Testing testing 123`,
            subcontent: [{ title: 'Section 2.2.1.1' }],
          },
          {
            title: 'Section 2.2.1',
            content: html`Testing testing 123`,
...
export class Tree {
  ...
  _compose(
    ...
    return html`<section id="${position}">${header} ${content}</section>
      ${children}`;
  }
  /**
  ...
  construct(section: PageSection[], root = []) {
    ...
    if (Array.isArray(section)) {
      for (let sub of section) {
        ...
        const href = `${location.join('.')}__${title}`.replace(
          /[^\w\d.]/g,
          '_'
        );
